...
implemented and reviewed after retry corrections; the
[DS-02D2B2 settlement plan](roadmaps/deferred-settlement-services.md) is
implemented and independently reviewed after causal-target, identity and accounting corrections.
...
- [ ] Close C1 schedule, terminal-record, persistence and evaluator decisions before implementation.
...
| [ ] | `DS-02` — Market Dataset And Baseline Evidence | `DS-D3B` satisfied; D2C runner/replay detail next |
...
- [ ] Complete market valuation and paper-transition rules in `DS-02D`.
  ...
  - [ ] Implement a causal pending/delayed-transition lifecycle (`DS-02D2`).
    ...
    - [ ] Integrate runner, round hashing and replay (`DS-02D2C` / `DS-D3`).
      ...
      - [ ] Freeze corrected atomic persistence and runner orchestration (`DS-02D2C1`, [spec](roadmaps/deferred-runner-orchestration.md)).
...
- [ ] `DS-02D2C`: integrate runner and replay; prove `DS-D3`.
  ...
  - [ ] `DS-02D2C1`: freeze corrected runner orchestration and persistence plan ([spec](roadmaps/deferred-runner-orchestration.md)).
